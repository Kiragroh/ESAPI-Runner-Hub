...
namespace EsapiRunnerHub.Catalog
{
    ...
    {
        private const string ScriptingMarker = "\\STR-Physik\\11. Scripting\\";
        ...
        public static string CompactPath(string path)
        {
            ...
            var markerIndex = normalized.IndexOf(ScriptingMarker, StringComparison.OrdinalIgnoreCase);
            if (markerIndex >= 0)
                return "Physik-Skripte\\" + normalized.Substring(markerIndex + ScriptingMarker.Length);
            try
            {
