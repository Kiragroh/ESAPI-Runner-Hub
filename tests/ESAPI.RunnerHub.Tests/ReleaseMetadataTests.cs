...
namespace EsapiRunnerHub.Tests
{
    internal static class ReleaseMetadataTests
    {
        ...
        {
            TestHarness.Test("release metadata identifies version 0.1.0 build 1", HasReleaseMetadata);
        ...
        private static void HasReleaseMetadata()
        {
            ...
            TestHarness.AssertContains(version, "\"version\": \"0.1.0\"");
            TestHarness.AssertContains(version, "\"build\": 1");
            TestHarness.AssertContains(changelog, "0.1.0");
